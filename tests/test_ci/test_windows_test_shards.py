...
RECENTLY_ADDED_ACTIVE_TESTS = {
    ...
    "tests/test_gateway/test_control_ui_asset_provider.py",
    "tests/test_gateway/test_control_ui_external_assets.py",
    "tests/test_gateway/test_control_ui_missing_assets.py",
    ...
    "tests/test_scripts/test_build_gateway_runtime.py",
    "tests/test_scripts/test_gateway_runtime_manifest.py",
    "tests/test_scripts/test_gateway_runtime_smoke.py",
