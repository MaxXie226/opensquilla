...
# explicitly so the selected Python installer keeps its original
...
if ($dryRun) {
    Write-Host 'install_source.ps1: dry-run — headless Gateway install; Node.js/npm are not required'
